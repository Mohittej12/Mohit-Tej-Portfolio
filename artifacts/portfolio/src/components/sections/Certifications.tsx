...
const certifications = [
  ...
  { name: "Cybersecurity Job Simulation", issuer: "Deloitte", icon: <ShieldCheck className="w-6 h-6" />, link: "https://forage-uploads-prod.s3.amazonaws.com/completion-certificates/9PBTqmSxAf6zZTseP/E9pA6qsdbeyEkp3ti_9PBTqmSxAf6zZTseP_7PC9ipFaLaStRrKF5_1752402065712_completion_certificate.pdf", buttonText: "Share Credential" },
